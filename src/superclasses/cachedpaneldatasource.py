...
class CachedPanelDataSource(object):
    ...
    def __init__(self, params: dict = None):
        super(CachedPanelDataSource, self).__init__()
        self.params = params
    ...
    def __repr__(self):
        return super(CachedPanelDataSource, self).__repr__() + str(self.params)
    ...
    def _run(self, entities: dict = None, period: tuple = None):
    ...
    def mismatch_period(self, period: tuple):
        if period is None:
    ...
    def mismatch_entities(self, entities: dict):
    ...
    @abstractmethod
    def update(self, entities=None, period: tuple = None):
        pass

    @abstractmethod
    def subset(self, entities=None, period: tuple = None):
        pass
